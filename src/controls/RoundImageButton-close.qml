...
Item {
    ...
    property color hoveredColor: LongUI.Theme.darkMode ? Qt.lighter(LongUI.Theme.wBoColor, 2)
                                                       : Qt.darker(LongUI.Theme.wBoColor, 1.1)
    property color pressedColor: LongUI.Theme.darkMode ? Qt.lighter(LongUI.Theme.wBoColor, 1.5)
