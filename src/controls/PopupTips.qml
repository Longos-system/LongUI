...
Window {
    ...
    property var borderColor: windowHelper.compositing ? LongUI.Theme.darkMode ? Qt.rgba(255, 255, 255, 0.3)
                                                                  : Qt.rgba(0, 0, 0, 0.2) : LongUI.Theme.darkMode ? Qt.rgba(255, 255, 255, 0.1)
                                                                                                                  : Qt.rgba(0, 0, 0, 0.05)
    flags: Qt.WindowStaysOnTopHint | Qt.WindowDoesNotAcceptFocus | Qt.ToolTip
    width: label.implicitWidth + LongUI.Units.largeSpacing * 1.5
    height: label.implicitHeight + LongUI.Units.largeSpacing * 1.5
    ...
    Rectangle {
        ...
        radius: windowHelper.compositing ? LongUI.Theme.mediumRadius : 0
    ...
    function adjustCorrectLocation() {
        ...
        if (posX <= Screen.virtualX)
            posX = Screen.virtualX + LongUI.Units.smallSpacing

        // top
        if (posY <= Screen.virtualY)
            posY = Screen.virtualY + LongUI.Units.smallSpacing
