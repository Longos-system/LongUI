...
Item {
    ...
    property color hoveredColor: LongUI.Theme.darkMode ? Qt.lighter(LongUI.Theme.backgroundColor, 2)
                                                       : Qt.darker(LongUI.Theme.backgroundColor, 1.1)
    property color pressedColor: LongUI.Theme.darkMode ? Qt.lighter(LongUI.Theme.backgroundColor, 1.5)
