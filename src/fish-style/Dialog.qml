...
T.Dialog {
    ...
    padding: LongUI.Theme.hugeRadius
    ...
    header: Item {
        id: _headerItem
        implicitHeight: _headerLabel.visible ? _headerLabel.implicitHeight + LongUI.Units.largeSpacing : 0
    ...
    footer: DialogButtonBox {
        visible: count > 0
        padding: LongUI.Units.largeSpacing * 2
    }
}